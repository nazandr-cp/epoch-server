...
func (c *Calculator) CalculateTotalEarned(subsidy subgraph.AccountSubsidy, endTimestamp int64) (*big.Int, error) {
...
func (c *Calculator) ProcessAccountSubsidies(subsidies []subgraph.AccountSubsidy, endTimestamp int64) ([]Entry, error) {
	var entries []Entry
